 ...
 */
final class metric_value_test extends basic_testcase {
     ...
     *
     * @dataProvider label_name_validation_provider
     * @covers \local_prometheus\metric_value::validate_labels
     *
     * @param string $name
     * @param bool $isvalid
     * @return void
     */
    public function test_label_name_validation(string $name, bool $isvalid): void {
        ...
        $labels = [];
        $labels[$name] = 'value';
        metric_value::validate_labels($labels);
    }

    /**
     * Data provider for {@see test_label_name_validation}
     *
     * @return array
     */
    public function label_name_validation_provider(): array {
        return [
            ...
            'has colon' => [ 'name' => 'mod:metric_name', 'isvalid' => false ],
